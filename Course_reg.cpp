...
class Course { public: int id; string code, name; int seats;
...
class Student { public: int id; string name; vector registered;
...
vector courses; vector students;

// ----------------------------------------------- // FUNCTIONS // -----------------------------------------------

void adminMenu(); void studentMenu(Student &s);

void addCourse() { int id, seats; string code, name;
...
void deleteCourse() { int cid; cout << "Enter Course ID to delete: "; cin >> cid;
...
void registerCourse(Student &s) { int cid; cout << "Enter Course ID to register: "; cin >> cid;
...
void dropCourse(Student &s) { int cid; cout << "Enter Course ID to drop: "; cin >> cid;
...
void adminMenu() { int choice; while (true) { cout << "\n--- ADMIN MENU ---\n"; cout << "1. Add Course\n"; cout << "2. Delete Course\n"; cout << "3. View Courses\n"; cout << "4. Back\n"; cout << "Enter choice: "; cin >> choice;
...
int main() { // Pre-adding one student for demo students.push_back(Student(1, "Harsh"));
